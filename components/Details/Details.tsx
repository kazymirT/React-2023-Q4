...
export const Details = () => {
  ...
  const productId: string = typeof router.query.id === 'string' ? router.query.id : '';
  const result = useGetProductByIdQuery(
    productId,
    {
    ...
    <div className={styles.container}>
      {data && (
        <div className={styles.item}>
          <Image src={data.images[0]} className={styles.img} width={300} height={300}  alt={data.title} />
          <h2>{data.title}</h2>
          <ul>
